document.addEventListener('DOMContentLoaded', () => {
    ...
    if (groupID) {
        ...
        let isGroupInitialized = false; // Flag to ensure the group is initialized before reacting to deletion

        // Set up Firebase listener for current song updates with a slight delay
        setTimeout(() => {
            if (currentSongRef) {
                currentSongRef.off(); // Detach any existing listener before attaching a new one
            }
